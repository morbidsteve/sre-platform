...
# Interactive script that generates a HelmRelease and commits it to Git.
# Usage: ./scripts/sre-deploy-app.sh [--non-interactive options...]
...
while IFS= read -r d; do
  ...
  # Only include directories that have a Chart.yaml
